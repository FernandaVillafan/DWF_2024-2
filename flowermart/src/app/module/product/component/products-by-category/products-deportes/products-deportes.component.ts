...
@Component({
  selector: 'app-products-deportes',
  templateUrl: './products-deportes.component.html',
  styleUrl: './products-deportes.component.css'
})
export class ProductsDeportesComponent {
  ...
  categoria : number = 3; // Categoria deportes
