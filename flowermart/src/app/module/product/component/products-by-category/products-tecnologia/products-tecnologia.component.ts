...
@Component({
  selector: 'app-products-tecnologia',
  templateUrl: './products-tecnologia.component.html',
  styleUrl: './products-tecnologia.component.css'
})
export class ProductsTecnologiaComponent {
  ...
  categoria : number = 1; // Categoria tecnologia
