...
@Component({
  selector: 'app-products-licoreria',
  templateUrl: './products-licoreria.component.html',
  styleUrl: './products-licoreria.component.css'
})
export class ProductsLicoreriaComponent {
  ...
  categoria : number = 4; // Categoria licoreria
