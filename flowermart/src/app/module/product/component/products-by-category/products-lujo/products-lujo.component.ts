...
@Component({
  selector: 'app-products-lujo',
  templateUrl: './products-lujo.component.html',
  styleUrl: './products-lujo.component.css'
})
export class ProductsLujoComponent {
  ...
  categoria : number = 5; // Categoria lujo
